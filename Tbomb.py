...
# Author: HM Borhan Uddin.
# GitHub: https://github.com/HM-BORHAN-BLACK-HOLE-CYBER
# Version: 4.1.0
#########################################
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Black_Hole.      \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber         \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/HM-BORHAN-BLACK-HOLE-CYBER\033[94m│".center(columns+9))
    print("│ \033[95mCoder  : HM Borhan Uddin      \033[37mV4.1 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
